...
/**
 * auhenticate user based on the user information (req.body)
 * @param {object} req .request for req.body req.parm.id of a user to authenticate if user it authenticate
 * @param {object} res 
 * @param {function} next  run middleware after authenticate may be setToken
 */
 ...
 *@param {function} setToken if a user genrerates token set and store as response header else unable to authenticate 
*/
